...
type Res struct {
	...
	In   []*ResInsert `protobuf:"bytes,2,rep,name=in,proto3" json:"in,omitempty"`
}
...
func (x *ResInsert) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResInsert) ProtoMessage() {}

func (x *ResInsert) ProtoReflect() protoreflect.Message {
	mi := &file_hello_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResInsert.ProtoReflect.Descriptor instead.
func (*ResInsert) Descriptor() ([]byte, []int) {
	return file_hello_proto_rawDescGZIP(), []int{1, 0}
}

func (x *ResInsert) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_hello_proto_rawDesc = []byte{
	...
	,
}
...
var file_hello_proto_goTypes = []interface{}{
	(*Req)(nil),       // 0: req
	(*Res)(nil),       // 1: res
	(*ResInsert)(nil), // 2: res.insert
}
var file_hello_proto_depIdxs = []int32{
	2, // 0: res.in:type_name -> res.insert
